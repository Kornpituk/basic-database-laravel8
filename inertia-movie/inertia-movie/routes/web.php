...
use App\Http\Controllers\Frontend\CastController as FrontendCastControllrt;
...
Route::get( '/casts', [FrontendCastControllrt::class, 'index'])->name('casts.index');
Route::get('/casts/{cast:slug}', [FrontendCastControllrt::class, 'show'])->name('casts.show');
