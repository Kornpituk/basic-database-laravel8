...
class EpisodeController extends Controller
{
    ...
    public function store(TvShow $tvShow, Season $season){
        ...
        // dd($tmdb_season);
         if ($tmdb_episode->successful()) {
            ...
            return Redirect::back()->with('flash.banner','Episode Api Error.'); 
        }
    }
    ...
    public function update(TvShow $tvShow, Season $season, Episode $episode){
        ...
        return Redirect::route('admin.episodes.index', [$tvShow->id, $season->id])->with('flash.banner','Episode Update.');
    }

    public function destroy(TvShow $tvShow, Season $season, Episode $episode){
        $episode->delete();
        return Redirect::route('admin.episodes.index', [$tvShow->id, $season->id])->with('flash.banner','Episode Delete.')->with('flash.bannerStyle','danger');
    }
