                ...
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                            <div class="p-1 flex items-center">
                                <label for="tmdb_id_g" class="block text-sm font-medium text-gray-700 mr-4">Movie Id</label>
                    ...
                    <div class="w-full mb-8 overflow-hidden bg-white rounded-lg shadow-lg">
                        <div class="p-2 m-2">
                            ...
                            <div class="flex">
                                <select v-model="movieFilters.perPage" @change="movieFilters.perPage === $event.target.value"
                            ...
                            <Table>
                                <template #tableHead>
                                    <tableHead class="cursor-pointer" @click="sort('title')">
                                        ...
                                        <span>Title</span>
                                            <svg v-if="movieFilters.column == 'title' && movieFilters.direction == 'desc'" 
                                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M17 13l-5 5m0 0l-5-5m5 5V6" />
                                            </svg>
                                            <svg v-if="movieFilters.column == 'title' && movieFilters.direction == 'asc'"  
                                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <tableHead class="cursor-pointer" @click="sort('rating')">
                                        <div class="flex space-x-4 content-center">
                                        <span>Rating</span>
                                            <svg v-if="movieFilters.column == 'rating' && movieFilters.direction == 'desc'"  
                                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M17 13l-5 5m0 0l-5-5m5 5V6" />
                                            </svg>
                                            <svg v-if="movieFilters.column == 'rating' && movieFilters.direction == 'asc'"  
                                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M7 11l5-5m0 0l5 5m-5-5v12" />
                                    ...
                                    <tableHead class="cursor-pointer" @click="sort('visits')">
                                        <div class="flex space-x-4 content-center">
                                        <span>Visits</span>
                                            <svg v-if="movieFilters.column == 'visits' && movieFilters.direction == 'desc'"   
                                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M17 13l-5 5m0 0l-5-5m5 5V6" />
                                            </svg>
                                            <svg v-if="movieFilters.column == 'visits' && movieFilters.direction == 'asc'"   
                                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M7 11l5-5m0 0l5 5m-5-5v12" />
                                ...
                                <TableRow v-for="movie in movies.data" :key="movie.id">
                                    ...
                                    <TableData>
                                        ...
                                        <div class="flex justify-center m-4">
                                            <ButtonLink :link="route('admin.movies.edit',movie.id)">Edit</ButtonLink><br>
                                        </div>
                                        <div class="flex justify-center m-4">
                                            <ButtonLink class="bg-red-500 hover:bg-red-700" :link="route('admin.movies.destroy',movie.id)" 
                                            method="delete" as="button" type="button">Delete</ButtonLink>
                                        </div>
                                    </TableData>
                                </TableRow>
                            </Table>
...
import Table from "@/Components/Casts/Table";
import TableData from "@/Components/Casts/TableData";
import TableHead from "@/Components/Casts/TableHead";
import TableRow from "@/Components/Casts/TableRow";
import ButtonLink from "@/Components/Casts/ButtonLink";
