                            ...
                            <Table>
                                ...
                                <TableRow v-for="cast in casts.data" :key="cast.id">
                                    ...
                                    <TableData>
                                        ...
                                        <div class="flex justify-center m-4">
                                            <ButtonLink class="bg-red-500 hover:bg-red-700" :link="route('admin.casts.destroy',cast.id)" 
...
function getCasts(){
    Inertia.get("/admin/casts", {perPage: perPage.value, search:search.value},
    {
        preserveState:true,
        replace:true,
    })
