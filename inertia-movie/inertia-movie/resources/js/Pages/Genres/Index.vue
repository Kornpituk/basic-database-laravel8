                                ...
                                <TableRow v-for="genre in genres.data" :key="genre.id">
                                    ...
                                    <TableData>
                                        <div class="flex justify-around">
                                            ...
                                            <ButtonLink class="bg-red-500 hover:bg-red-700" :link="route('admin.genres.destroy',genre.id)" 
...
function getGenres(){
    Inertia.get("/admin/genres", {perPage: perPage.value, search:search.value},
    {
        preserveState:true,
        replace:true,
    })
