                ...
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                            <div class="p-1 flex items-center">
                                <label for="tmdb_id_g" class="block text-sm font-medium text-gray-700 mr-4">Epides Number</label>
                                <div class="relative rounded-md shadow-sm">
                                    <input v-model="episodeNumber" id="tmdb_id_g" name="tmdb_id_g"
                                        class="px-3 py-2 border border-gray-300 rounded" placeholder="Epides Number" />
                                </div>
                            </div>
                            <div class="p-1">
                    ...
                    <div class="w-full mb-8 overflow-hidden bg-white rounded-lg shadow-lg">
                        <div class="p-2 m-2">
                            ...
                            <div class="flex">
                                <select v-model="perPage" @change="getEpisodes"
                                ...
                                <TableRow v-for="episode in episodes.data" :key="episode.id">
                                    ...
                                    <TableData>
                                        <div class="flex justify-around">
                                            ...
                                            <ButtonLink class="bg-red-500 hover:bg-red-700" :link="route('admin.episodes.destroy',[tvShow.id,season.id,episode.id])" 
