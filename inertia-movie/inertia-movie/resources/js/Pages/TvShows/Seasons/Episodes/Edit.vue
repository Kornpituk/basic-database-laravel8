                ...
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2">
                        <Link :href="route('admin.episodes.index',[tvShow.id, season.id])"
                            class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-lg">Episode Index</Link>
                    </div>
                    ...
                    <form @submit.prevent="submitEpisode">
                        ...
                        <div class="mt-4">
                         ...
                         <!-- <div class="mt-4">
                            <jet-label for="is_public" value="Public" />
                            <jet-input id="is_public" type="text" class="mt-1 block w-full" v-model="form.is_public" required />
