<template lang="">
                                ...
                                <div class="w-8/12">
                                    <div class="m-4 p-6">
                                        ...
                                        <div class="flex space-x-4">
                                            <button class="px-4 py-2 text-sm font-medium text-white bg-black rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75" 
    ...
    <TransitionRoot appear :show="isOpen" as="template">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            ...
            >
                <div
                class="inline-block w-full max-w-2 p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl"
                >
                <DialogTitle
                    as="h3"
                ...
                <div class="mt-2" v-if="modelTrailer">
                    <div class="aspect-w-16 aspect-h-9" v-html="modelTrailer.embed_html"></div>
                </div>
...
<script setup>
import FontLayout from '@/Layouts/FontLayout';
...
const modelTrailer = ref({})

function closeModal() {
        isOpen.value = false
      }
function openModal(trailer) {
        modelTrailer.value = trailer
        isOpen.value = true
      }
</script>
<style lang="">
